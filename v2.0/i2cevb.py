...
#works with GPIO feature, not hard wired
...
button_TIA = tk.Button(tab1, text="OFF", font=fontStyle,
                       command=lambda:[change_GPIO_0(), isClicked(button_TIA, TIA_text, TIA, 0x02, TIA_bits)])
...
TIA_submit = tk.Button(tab1, text="Submit", font=fontStyle,
                       command=lambda:[change_GPIO_0(), submit(TIA, TIA_voltage_entry, TIA_text, 0x10, "8")])
...
button_LED = tk.Button(tab1, text="OFF", font=fontStyle,
                       command=lambda:[change_GPIO_0(), isClicked(button_LED, LED_text, LED, 0x02, LED_bits)])
...
LED_submit = tk.Button(tab1, text="Submit", font=fontStyle,
                       command=lambda:[change_GPIO_0(), LED_sub(LED, LED_voltage_entry, LED_text, 0x2f)])
...
button_DRV = tk.Button(tab1, text="OFF", font=fontStyle,
                       command=lambda:[change_GPIO_0(), isClicked(button_DRV, DRV_text, DRV, 0x02, DRV_bits)])
...
DRV_submit = tk.Button(tab1, text="Submit", font=fontStyle,
                       command=lambda:[change_GPIO_0(), submit(DRV, DRV_voltage_entry, DRV_text, 0x11, "9")])
...
button_LA = tk.Button(tab1, text="OFF", font=fontStyle,
                      command=lambda:[change_GPIO_0(), isClicked(button_LA, LA_text, LA, 0x02, LA_bits)])
...
LA_submit = tk.Button(tab1, text="Submit", font=fontStyle,
                      command=lambda:[change_GPIO_1(), submit(LA, LA_voltage_entry, LA_text, 0x12, "a")])
...
button_BF = tk.Button(tab1, text="OFF", font=fontStyle,
                      command=lambda:[change_GPIO_0(), isClicked(button_BF, BF_text, BF, 0x02, BF_bits)])
...
BF_submit = tk.Button(tab1, text="Submit", font=fontStyle,
                      command=lambda:[change_GPIO_0(), submit(BF, BF_voltage_entry, BF_text, 0x13, "b")])
...
button_BG = tk.Button(tab1, text="OFF", font=fontStyle,
                      command=lambda:[change_GPIO_0(), isClicked(button_BG, BG_text, BG, 0x02, BG_bits)])
...
BG_submit = tk.Button(tab1, text="Submit", font=fontStyle,
                      command=lambda:[change_GPIO_0(), submit(BG, BG_voltage_entry, BG_text, 0x14, "c")])
...
button_PD = tk.Button(tab1, text="OFF", font=fontStyle,
                      command=lambda:[change_GPIO_0(), isClicked(button_PD, PD_text, PD, 0x02, PD_bits)])
...
PD_submit = tk.Button(tab1, text="Submit", font=fontStyle,
                      command=lambda:[change_GPIO_0(), submit(PD, PD_voltage_entry, PD_text, 0x15,"d")])
...
button_V2_5 = tk.Button(tab1, text="OFF", font=fontStyle,
                        command=lambda:[change_GPIO_0(), isClicked(button_V2_5, V2_5_text, V2_5, 0x02, V2_5_bits)])
...
V2_5_submit = tk.Button(tab1, text="Submit", font=fontStyle,
                        command=lambda:[change_GPIO_0(), submit(V2_5, V2_5_voltage_entry, V2_5_text, 0x16, "e")])
...
button_V1_8 = tk.Button(tab1, text="OFF", font=fontStyle,
                        command=lambda:[change_GPIO_0(), isClicked(button_V1_8, V1_8_text, V1_8, 0x03, V1_8_bits)])
...
V1_8_submit = tk.Button(tab1, text="Submit", font=fontStyle,
                        command=lambda:[change_GPIO_0(), submit(V1_8, V1_8_voltage_entry, V1_8_text, 0x17, "f")])
...
def read0xxx(channel, entry):
    bits = bus.read_byte_data(0x55, channel)
...
read_0x00_button = tk.Button(tab2, text='Read', command=lambda:[change_GPIO_1(), delete0xxx(output_blank_0x00), read0xxx(0x00, output_blank_0x00)])
write_0x00_button = tk.Button(tab2, text='Write', command=lambda:[change_GPIO_1(), write0x00])
...
read_0x01_button = tk.Button(tab2, text='Read', command=lambda:[change_GPIO_1(), delete0xxx(output_blank_0x01), read0xxx(0x01, output_blank_0x01)])
write_0x01_button = tk.Button(tab2, text='Write', command=lambda:[change_GPIO_1(),write0x01])
...
read_0x02_button = tk.Button(tab2, text='Read', command=lambda:[change_GPIO_1(), delete0xxx(output_blank_0x02), read0xxx(0x02, output_blank_0x02)])
write_0x02_button = tk.Button(tab2, text='Write', command=lambda:[change_GPIO_1(), write0x02])
...
read_0x03_button = tk.Button(tab2, text='Read', command=lambda:[change_GPIO_1(), delete0xxx(output_blank_0x03), read0xxx(0x03, output_blank_0x03)])
write_0x03_button = tk.Button(tab2, text='Write', command=lambda:[change_GPIO_1(),write0x03])
...
read_0x04_button = tk.Button(tab2, text='Read', command=lambda:[change_GPIO_1(), delete0xxx(output_blank_0x04), read0xxx(0x04, output_blank_0x04)])
write_0x04_button = tk.Button(tab2, text='Write', command=lambda:[change_GPIO_1(), write0x04])
...
read_0x05_button = tk.Button(tab2, text='Read', command=lambda:[change_GPIO_1(),delete0xxx(output_blank_0x05), read0xxx(0x05, output_blank_0x05)])
...
read_0x06_button = tk.Button(tab2, text='Read', command=lambda:[change_GPIO_1(),delete0xxx(output_blank_0x06), read0xxx(0x06, output_blank_0x06)])
...
read_0x07_button = tk.Button(tab2, text='Read', command=lambda:[change_GPIO_1(), delete0xxx(output_blank_0x07), read0xxx(0x07, output_blank_0x07)])
write_0x07_button = tk.Button(tab2, text='Write', command=lambda:[change_GPIO_1(), write0x07])
...
read_0x08_button = tk.Button(tab2, text='Read', command=lambda:[change_GPIO_1(), delete0xxx(output_blank_0x08), read0xxx(0x08, output_blank_0x08)])
...
read_0x09_button = tk.Button(tab2, text='Read', command=lambda:[change_GPIO_1(), delete0xxx(output_blank_0x09), read0xxx(0x09, output_blank_0x09)])
write_0x09_button = tk.Button(tab2, text='Write', command=lambda:[change_GPIO_1(), write0x09])
...
read_0x0A_button = tk.Button(tab2, text='Read', command=lambda:[change_GPIO_1(), delete0xxx(output_blank_0x0A), read0xxx(0x0A, output_blank_0x0A)])
write_0x0A_button = tk.Button(tab2, text='Write', command=lambda:[change_GPIO_1(), write0x0A])
...
read_0x0B_button = tk.Button(tab2, text='Read', command=lambda:[change_GPIO_1(), delete0xxx(output_blank_0x0B), read0xxx(0x0B, output_blank_0x0B)])
write_0x0B_button = tk.Button(tab2, text='Write', command=lambda:[change_GPIO_1(), write0x0B])
...
read_0x0C_button = tk.Button(tab2, text='Read', command=lambda:[change_GPIO_1(), delete0xxx(output_blank_0x0C), read0xxx(0x0C, output_blank_0x0C)])
write_0x0C_button = tk.Button(tab2, text='Write', command=lambda:[change_GPIO_1(), write0x0C])
...
read_0x0D_button = tk.Button(tab2, text='Read', command=lambda:[change_GPIO_1(), delete0xxx(output_blank_0x0D), read0xxx(0x0D, output_blank_0x0D)])
write_0x0D_button = tk.Button(tab2, text='Write', command=lambda:[change_GPIO_1(), write0x0D])
...
read_0x0E_button = tk.Button(tab2, text='Read', command=lambda:[change_GPIO_1(), delete0xxx(output_blank_0x0E), read0xxx(0x0E, output_blank_0x0E)])
write_0x0E_button = tk.Button(tab2, text='Write', command=lambda:[change_GPIO_1(), write0x0E])
...
read_0x0F_button = tk.Button(tab2, text='Read', command=lambda:[change_GPIO_1(), delete0xxx(output_blank_0x0F), read0xxx(0x0F, output_blank_0x0F)])
write_0x0F_button = tk.Button(tab2, text='Write', command=lambda:[change_GPIO_1(), write0x0F])

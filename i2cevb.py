...
description_0x00 = tk.Label(tab2, text="bandgap",font=fontStyle)
entry_0x00 = tk.Entry(tab2, width=5)
input_text_0x00 = tk.Label(tab2, text="5-trimming code",font=fontStyle)
output_text_0x00 = tk.Label(tab2, text="output: ",font=fontStyle)
...
description_0x01 = tk.Label(tab2, text="TIA ref and bias current",font=fontStyle)
entry_0x01_47 = tk.Entry(tab2,width=4)
entry_0x01_02 = tk.Entry(tab2,width=3)
input_text_0x01 = tk.Label(tab2, text="4-bias control",font=fontStyle)
input_text_0x01_2 = tk.Label(tab2, text="3-TIA voltage",font=fontStyle)
output_text_0x01 = tk.Label(tab2, text="output: ",font=fontStyle)
...
description_0x02 = tk.Label(tab2, text="VDD12 ref",font=fontStyle)
...
input_text_0x02 = tk.Label(tab2, text="1-LEDDRV_PD",font=fontStyle)
input_text_0x02_2 = tk.Label(tab2, text="1-LED PD",font=fontStyle)
input_text_0x02_3 = tk.Label(tab2, text="1-TIA_PD",font=fontStyle)
input_text_0x02_4 = tk.Label(tab2, text="3-VDD12 REF",font=fontStyle)
output_text_0x02 = tk.Label(tab2, text="output: ",font=fontStyle)
...
description_0x03 = tk.Label(tab2, text="offset cancellation ref",font=fontStyle)
entry_0x03_57 = tk.Entry(tab2,width=3)
entry_0x03_04 = tk.Entry(tab2,width=5)
input_text_0x03 = tk.Label(tab2, text="3-o.c swing",font=fontStyle)
input_text_0x03_2 = tk.Label(tab2, text="5-o.c ref ctrl",font=fontStyle)
output_text_0x03 = tk.Label(tab2, text="output: ",font=fontStyle)
...
input_text_0x04 = tk.Label(tab2, text="1-freeze",font=fontStyle)
input_text_0x04_2 = tk.Label(tab2, text="3-o.c gain",font=fontStyle)
output_text_0x04 = tk.Label(tab2, text="output: ",font=fontStyle)
...
input_text_0x05 = tk.Label(tab2, text="5-o.c max",font=fontStyle)
output_text_0x05 = tk.Label(tab2, text="output: ",font=fontStyle)
...
input_text_0x06 = tk.Label(tab2, text="5-o.c min",font=fontStyle)
output_text_0x06 = tk.Label(tab2, text="output: ",font=fontStyle)
...
input_text_0x07 = tk.Label(tab2, text="8-o.c channel monitored",font=fontStyle)
output_text_0x07 = tk.Label(tab2, text="output: ",font=fontStyle)
...
input_text_0x08 = tk.Label(tab2, text="1-global lock",font=fontStyle)
input_text_0x08_2 = tk.Label(tab2, text="5-o.c DAC level",font=fontStyle)
output_text_0x08 = tk.Label(tab2, text="output: ",font=fontStyle)
...
input_text_0x09 = tk.Label(tab2, text="5-o.c DAC override",font=fontStyle)
output_text_0x09 = tk.Label(tab2, text="output: ",font=fontStyle)
...
description_0x0A = tk.Label(tab2, text="LED CONTROL",font=fontStyle)
entry_0x0A_04 = tk.Entry(tab2,width=5)
input_text_0x0A = tk.Label(tab2, text="5-LED BIAS",font=fontStyle)
output_text_0x0A = tk.Label(tab2, text="output: ",font=fontStyle)
...
input_text_0x0B = tk.Label(tab2, text="5-LED MOD",font=fontStyle)
output_text_0x0B = tk.Label(tab2, text="output: ",font=fontStyle)
...
input_text_0x0C = tk.Label(tab2, text="2-LED boost",font=fontStyle)
output_text_0x0C = tk.Label(tab2, text="output: ",font=fontStyle)
...
input_text_0x0D = tk.Label(tab2, text="5-Input signal reference",font=fontStyle)
output_text_0x0D = tk.Label(tab2, text="output: ",font=fontStyle)
...
input_text_0x0E = tk.Label(tab2, text="5-Common Mod Ref",font=fontStyle)
output_text_0x0E = tk.Label(tab2, text="output: ",font=fontStyle)
...
input_text_0x0F = tk.Label(tab2, text="2-spare bits",font=fontStyle)
input_text_0x0F_2 = tk.Label(tab2, text="3-test_mux8",font=fontStyle)
input_text_0x0F_22 = tk.Label(tab2, text="\n0-nothing\n1-REFH\n2-REFL\n3-compref\n4-VDD12ref\n5-DAC1INN\n6-DACINP\n7-VOCMFP",font=fontStyle)
input_text_0x0F_3 = tk.Label(tab2, text="2-test_mux",font=fontStyle)
input_text_0x0F_33 = tk.Label(tab2, text="\n0-TIA REF\n1-VBIAS18",font=fontStyle)
input_text_0x0F_4 = tk.Label(tab2, text="1-Protect LED driver",font=fontStyle)
output_text_0x0F = tk.Label(tab2, text="output: ",font=fontStyle)
